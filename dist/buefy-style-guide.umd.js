...
(function (global, factory) {
	...
	var script$2 = {
	  ...
	  methods: {
	    ...
	    openConfirm: function openConfirm(dialogSize, dialogType) {
	      ...
	      var confirm = this.$buefy.dialog.confirm({
	...
	var __vue_staticRenderFns__$2 = [];
	  ...
	  /* scoped */
	  const __vue_scope_id__$2 = "data-v-598b8bfb";
	  /* module identifier */
